...
# Loop over sites
site_list = SETTINGS['Options']['SiteList'].strip('"').split(",")
for site in site_list:
    ...
    response = requests.get(fhir_store_path + "/Patient?identifier=https://cnics.cirg.washington.edu/site-patient-id/" + site + "|&_format=json&_count=" + fhir_max_count)
